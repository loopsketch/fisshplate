...
import org.seasar.fisshplate.core.element.RowElement;
...
public class FPParserTest extends TestCase {
	...
	public void test解析テスト1()throws Exception{
		...
		assertEquals(RowElement.class,row.getClass());
		List cellList = ((RowElement)row).getCellElementList();		
		...
		cellList = ((RowElement)row).getCellElementList();
		...
		assertEquals(RowElement.class, child.getClass());
		cellList = ((RowElement)child).getCellElementList();		
